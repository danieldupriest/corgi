...
/**
 * These are the base field types which encapsulate the conversion methods
 * used throughout the back end. New types can be added to the array.
 */
...
/**
 * These are the declarations of fields to be managed within Contact objects.
 * If these entries are changed, the database must be regenerated by running
 * npm run init. This will delete the existing data.
 */
...
/**
 * Utility function to retrieve a field by its name.
 * @param fieldName (string) - Name of the field
 * @returns (DbField) - field object
 */
